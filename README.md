...
| 功能 | 描述 |
|------|------|
| 🔍 **论文筛选推送** | 从 ArXiv RSS 自动获取最新论文，使用 DeepSeek-V4-Pro 智能评分筛选 |
...
| 场景 | 模型 | 说明 |
|------|------|------|
| 论文筛选评分 | `deepseek-v4-pro` | 思考模式，高质量推理 |
| 论文翻译 | `deepseek-v4-flash` | 非思考模式，响应速度更快 |
| 摘要总结 | `deepseek-v4-flash` | 非思考模式，响应速度更快 |
...
| Feature | Description |
|---------|-------------|
| 🔍 **Paper Filtering** | Automatically fetch latest papers from ArXiv RSS, intelligent scoring with DeepSeek-V4-Pro |
...
This project uses DeepSeek-V4:

| Scenario | Model | Description |
|----------|-------|-------------|
| Paper Scoring | `deepseek-v4-pro` | Thinking mode, higher reasoning quality |
| Translation | `deepseek-v4-flash` | Non-thinking mode, faster response |
| Summarization | `deepseek-v4-flash` | Non-thinking mode, faster response |
